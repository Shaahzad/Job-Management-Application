        ...
        >
          <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
            <img
              ...
              src="data:image/png;base64,..." // yahan aapka image URL
              alt="job"
            />
            <p>{job.title}</p>
          </div>
